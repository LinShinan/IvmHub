package com.stone.manage.domain;
 ...
 * @date 2026-04-17
 */
@ExcelIgnoreUnannotated@HeadRowHeight(25)
@HeadStyle(fillPatternType = FillPatternTypeEnum.SOLID_FOREGROUND, fillForegroundColor =  13)
@HeadFontStyle(fontHeightInPoints = 12, fontName = "微软雅黑", bold = com.alibaba.excel.enums.BooleanEnum.TRUE, color = 0)
@ColumnWidth(20)
